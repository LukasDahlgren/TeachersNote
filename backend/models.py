...
class Lecture(Base):
    ...
    naming_kind = Column(String(64), nullable=True)
    naming_lecture = Column(String(255), nullable=True)
    naming_year = Column(String(4), nullable=True)
    upload_courseid_raw = Column(String(64), nullable=True)
    upload_kind_raw = Column(String(64), nullable=True)
    upload_lecture_raw = Column(String(255), nullable=True)
    upload_year_raw = Column(String(4), nullable=True)
